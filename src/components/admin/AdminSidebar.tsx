...
const SIDEBAR_SECTIONS: SidebarSection[] = [
  {
    ...
    items: [
      ...
      { name: "Welcome & Goodbye", href: "/admin/welcome", icon: "wave" },
      { name: "Reaction Roles", href: "/admin/reaction-roles", icon: "reaction" },
      { name: "Moderator", href: "/admin/moderator", icon: "shield" },
      { name: "Levels & XP", href: "/admin/levels", icon: "trophy" },
      { name: "Achievements", href: "/admin/achievements", icon: "medal" },
      { name: "Starboards", href: "/admin/starboards", icon: "star", badge: "New" },
    ],
  },
  {
    title: "Server Management",
    items: [
      { name: "Automations", href: "/admin/automations", icon: "bolt" },
      { name: "Custom Commands", href: "/admin/commands", icon: "terminal" },
      { name: "Invite Tracker", href: "/admin/invites", icon: "link" },
      { name: "Ticketing", href: "/admin/tickets", icon: "ticket" },
    ],
  },
  {
    title: "Utilities",
    items: [
      { name: "Polls", href: "/admin/polls", icon: "chart" },
      { name: "Embed Messages", href: "/admin/embeds", icon: "embed" },
      { name: "Reminders", href: "/admin/reminders", icon: "clock" },
      { name: "Stats Channels", href: "/admin/stats-channels", icon: "stats" },
      { name: "Temp Channels", href: "/admin/temp-channels", icon: "channel" },
    ],
  },
  {
    title: "Social Alerts",
    items: [
      { name: "Twitch Alerts", href: "/admin/alerts/twitch", icon: "twitch" },
      { name: "YouTube Alerts", href: "/admin/alerts/youtube", icon: "youtube" },
      { name: "TikTok Alerts", href: "/admin/alerts/tiktok", icon: "tiktok" },
      { name: "Kick Alerts", href: "/admin/alerts/kick", icon: "kick" },
      { name: "X Alerts", href: "/admin/alerts/x", icon: "x" },
      { name: "Instagram Alerts", href: "/admin/alerts/instagram", icon: "instagram" },
      { name: "Facebook Alerts", href: "/admin/alerts/facebook", icon: "facebook" },
      { name: "Reddit Alerts", href: "/admin/alerts/reddit", icon: "reddit" },
      { name: "RSS Feeds", href: "/admin/alerts/rss", icon: "rss" },
    ],
  },
  {
    title: "Games & Fun",
    items: [
      { name: "Economy", href: "/admin/economy", icon: "coins" },
      { name: "Giveaways", href: "/admin/giveaways", icon: "gift" },
      { name: "Birthdays", href: "/admin/birthdays", icon: "cake" },
      { name: "Music Quiz", href: "/admin/music-quiz", icon: "music" },
    ],
  },
  {
    title: "LISA AI",
    items: [
      { name: "Personality", href: "/admin/lisa/personality", icon: "brain" },
      { name: "Responses", href: "/admin/lisa/responses", icon: "chat" },
      { name: "Knowledge", href: "/admin/lisa/knowledge", icon: "book" },
    ],
  },
  {
    title: "PRISMAI Engine",
    items: [
      { name: "Auto-Post", href: "/admin/autopost", icon: "megaphone" },
      { name: "Stream Control", href: "/admin/stream", icon: "video" },
      { name: "Platforms", href: "/admin/platforms", icon: "grid" },
      { name: "Chat Bridge", href: "/admin/bridge", icon: "arrows" },
...
const ICONS: Record<string, React.ReactNode> = {
  ...
  wave: <path strokeLinecap="round" strokeLinejoin="round" d="M10.05 4.575a1.575 1.575 0 1 0-3.15 0v3m3.15-3v-1.5a1.575 1.575 0 0 1 3.15 0v1.5m-3.15 0 .075 5.925m3.075.75V4.575m0 0a1.575 1.575 0 0 1 3.15 0V15M6.9 7.575a1.575 1.575 0 1 0-3.15 0v8.175a6.75 6.75 0 0 0 6.75 6.75h2.018a5.25 5.25 0 0 0 3.712-1.538l1.732-1.732a5.25 5.25 0 0 0 1.538-3.712l.003-2.024a.668.668 0 0 1 .198-.471 1.575 1.575 0 1 0-2.228-2.228 3.818 3.818 0 0 0-1.12 2.687M6.9 7.575V12m6.27 4.318A4.49 4.49 0 0 1 16.35 15m.002 0h-.002" />,
  reaction: <path strokeLinecap="round" strokeLinejoin="round" d="M15.182 15.182a4.5 4.5 0 0 1-6.364 0M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75Zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75Z" />,
  ...
  trophy: <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 0 1-.982-3.172M9.497 14.25a7.454 7.454 0 0 0 .981-3.172" />,
  medal: <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />,
  star: <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />,
  ...
  embed: <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" />,
  clock: <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />,
  stats: <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z" />,
  channel: <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.8-13.5-3.9 19.5m-2.1-19.5-3.9 19.5" />,
  ...
  brain: <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />,
  ...
  rss: <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 19.5v-.75a7.5 7.5 0 0 0-7.5-7.5H4.5m0-6.75h.75c7.87 0 14.25 6.38 14.25 14.25v.75M6 18.75a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />,
  ...
  arrows: <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />,
};
...
const SOCIAL_ICONS: Record<string, string> = {
  ...
  kick: "M1.333 0v24H8v-8l2.667 2.667L16 24h6.667L16 17.333 22.667 8H16l-5.333 5.333V0z",
...
function Icon({ name, className }: { name: string; className?: string }) {
  const isSocial = ["twitch", "youtube", "tiktok", "kick", "x", "instagram", "facebook", "reddit"].includes(name);
...
export default function AdminSidebar({ children }: { children: React.ReactNode }) {
  ...
  const currentPage = SIDEBAR_SECTIONS
    .flatMap((s) => s.items)
          ...
          <div className="border-b border-white/5 p-3">
            <button className="flex w-full items-center gap-3 rounded-lg bg-white/5 p-2.5 transition-colors hover:bg-white/10">
              ...
              <div className="flex-1 text-left">
                <p className="text-sm font-medium text-white">Prozilli HQ</p>
                <p className="text-[10px] text-gray-400">Discord Server</p>
              </div>
          ...
          {SIDEBAR_SECTIONS.map((section, sectionIdx) => (
            <div key={sectionIdx}>
              {section.title && sidebarOpen && (
                <h3 className="mb-1 px-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500">
                  {section.title}
                </h3>
              )}
