      ...
      <section className="py-24 bg-base relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="badge badge-electric mb-4">Live Community</div>
              <h2 className="text-headline mb-6">
                See Who&apos;s <span className="text-shimmer">Online</span>
              </h2>
              <p className="text-body-lg mb-6">
                The Prozilli HQ Discord is where the community hangs out. Voice chat sessions,
                game nights, giveaways, and LISA roasting people in real-time. Jump in and say
                what&apos;s up.
              </p>
              <ul className="space-y-3 mb-8">
                {[
                  "Live member count and voice channels",
                  "LISA AI active in every channel",
                  "Stream notifications across 9 platforms",
                  "Weekly giveaways and community events",
                  "Direct access to Pro and the team",
                ].map((feature) => (
                  <li key={feature} className="flex items-center gap-3 text-sm text-muted">
                    <span className="w-1.5 h-1.5 rounded-full bg-electric flex-shrink-0" />
                    {feature}
