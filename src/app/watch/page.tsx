...
export const metadata: Metadata = {
  title: "Watch Live",
  description:
    "Watch ProzilliGaming live across 9 platforms simultaneously. Twitch, YouTube, Kick, TikTok, X, Instagram, Facebook, Trovo, and Discord — all powered by PRISMAI.",
};
...
const PLATFORMS = [
  {
    ...
    desc: "Primary home. Chat with LISA, earn channel points, and catch every stream.",
  ...
  },
  {
    ...
    desc: "VODs, highlights, Shorts, and full stream archives.",
  ...
  },
  {
    ...
    desc: "Zero-delay streaming. LISA responds here too.",
    icon: "M7 2v20l5-5 5 5V2H7z",
  },
  {
    name: "TikTok",
    color: "#ff0050",
    href: "https://tiktok.com/@ProzilliGaming",
    desc: "Short-form clips, highlights, and AI-generated content.",
  ...
  },
  {
    ...
    desc: "Stream announcements, clips, and community banter.",
  ...
  },
  {
    ...
    desc: "Behind the scenes, stories, Reels, and highlights.",
  ...
  },
  {
    ...
    desc: "Prozilli Gaming page. Stream alerts and Reels.",
  ...
  },
  {
    ...
    desc: "Alternative streaming platform with LISA chat support.",
  ...
  },
  {
    ...
    desc: "Prozilli HQ. Chat, LISA interaction, stream notifications.",
          ...
          <div className="glass-raised rounded-2xl overflow-hidden">
            <div className="aspect-video bg-surface flex items-center justify-center relative">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-lg font-semibold mb-2">Stream Player</p>
                <p className="text-sm text-muted">
                  Live stream embed loads when ProzilliGaming goes live
                </p>
              </div>
            </div>
            {/* Player controls bar */}
            <div className="glass p-4 flex items-center justify-between border-t border-glass-border">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-muted">on Twitch</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xs text-muted">Also streaming on 8 other platforms</span>
            ...
            {[
              ...
              <div key={clip.title} className="card group overflow-hidden">
                <div className="aspect-video bg-surface relative flex items-center justify-center">
                  ...
                  <div className="absolute bottom-2 right-2 text-data bg-void/80 px-2 py-0.5 rounded text-xs">
                    {clip.duration}
                  </div>
                </div>
                <div className="p-4">
                  <h3 className="text-sm font-bold mb-1 group-hover:text-foreground transition-colors">
                    {clip.title}
                  </h3>
              ...
              {[
                {
                  ...
                  desc: "Auto-refresh OAuth across 9 platforms with AES-256-GCM encryption at rest",
                  icon: "M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z",
                },
                {
                  label: "Webhook Pipeline",
                  desc: "Real-time event processing from Twitch, PayPal, Stripe, Fourthwall, and more",
                  icon: "M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5",
                },
                {
                  label: "LISA AI Bridge",
                  desc: "Single AI personality present in every chat, every platform, simultaneously",
