...
// .wrangler/tmp/pages-XjgOY4/functionsWorker-0.7800415240304722.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var PRISMAI_CORE = "http://bot-service-na-west-01.cybrancee.com:5084";
var PRISMAI_ANALYTICS = "http://cybrancee-bot-na-east-08.cybrancee.com:5018";
var ALLOWED_ORIGINS = [
  "https://prozilli.com",
...
var onRequestGet = /* @__PURE__ */ __name2(async (context) => {
  ...
  if (path === "health") {
    ...
    const coreResult = core.status === "fulfilled" && core.value.ok ? core.value.data : { status: "offline" };
    const analyticsResult = analytics.status === "fulfilled" && analytics.value.ok ? analytics.value.data : { status: "offline" };
    return new Response(
...
async function proxyMutatingRequest(context, method) {
  const path = context.params.path?.join("/") || "";
  try {
...
__name(proxyMutatingRequest, "proxyMutatingRequest");
__name2(proxyMutatingRequest, "proxyMutatingRequest");
...
// .wrangler/tmp/bundle-QMV77P/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-QMV77P/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7800415240304722.js.map
